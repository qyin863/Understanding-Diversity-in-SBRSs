...
#        self.psru, self.psru1, self.psru2 = PSRU(self.embedding_dim), PSRU(self.embedding_dim), PSRU(self.embedding_dim)
...
#        pos_inner = context_embedding.matmul(pos_embs.t()) # batch_size * #items * #items
        # bmm may memory lesser than matmul try it below !
        try:
